...
for product_row in range(2, product_list.max_row + 1):
    ...
    #calculations for number of products per supplier
    ...
    if inventory < 10 :
        product_inv_under_10[int(product_num)] = int(inventory)
...
#saving the total price into a new file
